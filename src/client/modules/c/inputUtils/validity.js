...
const labelPatternMismatch  = "Temp" ;  
const labelBadInput  = "Temp" ;  
const labelRangeOverflow  = "Temp" ;  
const labelRangeUnderflow  = "Temp" ;  
const labelStepMismatch = "Temp" ;  
const labelTooLong  = "Temp" ;  
const labelTooShort  = "Temp" ;  
const labelTypeMismatch = "Temp" ;  
const labelValueMissing  = "Temp" ;  
